...
"[project]/node_modules/@mozilla/readability/Readability.js [app-rsc] (ecmascript)": ((__turbopack_context__) => {
    ...
    if (this._debug) {
        ...
        this.log = function() {
            if (typeof console !== "undefined") {
                ...
                /* global dump */ var msg = Array.prototype.map.call(arguments, function(x) {
...
Readability.prototype = {
   ...
   */ _fixRelativeUris (articleContent) {
        ...
        var links = this._getAllNodesWithTag(articleContent, [
            "a"
        ]);
    ...
    _simplifyNestedElements (articleContent) {
        ...
        while(node){
            if (node.parentNode && [
                "DIV",
                "SECTION"
            ].includes(node.tagName) && !(node.id && node.id.startsWith("readability"))) {
   ...
   **/ _getArticleTitle () {
        ...
        if (/ [\|\-\\\/>»] /.test(curTitle)) {
            ...
            var headings = this._getAllNodesWithTag(doc, [
                "h1",
                "h2"
            ]);
   ...
   **/ _prepDocument () {
        ...
        this._removeNodes(this._getAllNodesWithTag(doc, [
            "style"
        ]));
        if (doc.body) {
            this._replaceBrs(doc.body);
        }
        this._replaceNodeTags(this._getAllNodesWithTag(doc, [
            "font"
        ]), "SPAN");
    },
    /**
   ...
   **/ _prepArticle (articleContent) {
        ...
        this._replaceNodeTags(this._getAllNodesWithTag(articleContent, [
            "h1"
        ]), "h2");
        // Remove extra paragraphs
        this._removeNodes(this._getAllNodesWithTag(articleContent, [
            "p"
        ]), function(paragraph) {
        ...
        this._forEachNode(this._getAllNodesWithTag(articleContent, [
            "br"
        ]), function(br) {
   ...
   * @return Element
   **/ /* eslint-disable-next-line complexity */ _grabArticle (page) {
       ...
       **/ var candidates = [];
            ...
            if (parseSuccessful) {
                ...
                var ancestors = [
                    ...
                    topCandidate
                ].concat(this._getNodeAncestors(parentOfTopCandidate));
   ...
   */ _getJSONLD (doc) {
        var scripts = this._getAllNodesWithTag(doc, [
            "script"
        ]);
        var metadata;
   ...
   **/ _clean (e, tag) {
        ...
        this._removeNodes(this._getAllNodesWithTag(e, [
            tag
        ]), function(element) {
   ...
   */ _markDataTables (root) {
    ...
    /* convert images and figures that have properties like data-src into images that can be loaded without JS */ _fixLazyImages (root) {
        this._forEachNode(this._getAllNodesWithTag(root, [
            ...
            for(var j = 0; j < elem.attributes.length; j++){
                ...
                if (copyTo) {
                    ...
                    } else if (elem.tagName === "FIGURE" && !this._getAllNodesWithTag(elem, [
                        "img",
                        "picture"
                    ]).length) {
   ...
   **/ _cleanConditionally (e, tag) {
        ...
        this._removeNodes(this._getAllNodesWithTag(e, [
            ...
            if (!isList) {
                var listLength = 0;
                var listNodes = this._getAllNodesWithTag(node, [
                    "ul",
                    "ol"
                ]);
            ...
            if ([
                ...node.getElementsByTagName("table")
            ].some((tbl)=>tbl._readabilityDataTable)) {
                return false;
            }
   ...
   * @return void
   **/ _cleanHeaders (e) {
        let headingNodes = this._getAllNodesWithTag(e, [
            "h1",
            "h2"
        ]);
...
if ("TURBOPACK compile-time truthy", 1) {
    /* eslint-disable-next-line no-redeclare */ /* global module */ module.exports = Readability;
}
}}),
"[project]/node_modules/@mozilla/readability/Readability-readerable.js [app-rsc] (ecmascript)": ((__turbopack_context__) => {
...
if ("TURBOPACK compile-time truthy", 1) {
    /* eslint-disable-next-line no-redeclare */ /* global module */ module.exports = isProbablyReaderable;
}
}}),
"[project]/node_modules/@mozilla/readability/index.js [app-rsc] (ecmascript)": ((__turbopack_context__) => {

var { m: module, e: exports } = __turbopack_context__;
{
/* eslint-env node */ var Readability = __turbopack_context__.r("[project]/node_modules/@mozilla/readability/Readability.js [app-rsc] (ecmascript)");
var isProbablyReaderable = __turbopack_context__.r("[project]/node_modules/@mozilla/readability/Readability-readerable.js [app-rsc] (ecmascript)");
module.exports = {
    Readability,
...
//# sourceMappingURL=node_modules_%40mozilla_readability_aadd00f1._.js.map