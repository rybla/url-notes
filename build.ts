...
cliConfig.outdir = cliConfig.outdir || config.output_dirpath;
...
await cp(config.notes_dirpath, `${config.output_dirpath}/note`, {
  recursive: true,
});

console.log(`✅ Copied notes directory to output\n`);
