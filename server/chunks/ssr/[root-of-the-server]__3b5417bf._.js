...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$analysis$2f$console$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/analysis/console.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdfdataextract$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/pdfdataextract/dist/index.js [app-rsc] (ecmascript)");
;
;
;
;
...
async function fetchArticle(url) {
    try {
        ...
        if (pdfData !== null) {
            ...
            return {
                url,
                title: pdfData.info?.Title ?? (pdfData.outline !== undefined && pdfData.outline.length > 0 ? pdfData.outline[0].title : url),
                publishedTime: pdfData.info?.CreationDate,
                content: pdfData.text.join("\n"),
                byline: pdfData.info?.Author,
                textContent: pdfData.text.join("\n"),
                tags: pdfData.info?.Keywords?.split(",").map((s)=>s.trim()).filter((s)=>s.length > 0)
            };
        }
        // default case
...
async function generateSummary(content) {
    const summary = (await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$analysis$2f$ai$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["gemini"](`
...
async function generateTags(article, summary) {
    const title = article.title;
    const tags = (await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$analysis$2f$ai$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["gemini"](`
...
`, {
    ...
    if (tags.length === 0 && (article.tags === undefined || article.tags.length === 0)) return null;
...
async function fetchPdfText(url) {
    try {
        ...
        if (!contentType || !contentType.includes("application/pdf")) {
            console.error(`Invalid content type: ${contentType} for URL: ${url}. Expected application/pdf.`);
            return null;
        }
        const arrayBuffer = await response.arrayBuffer();
        const buffer = Buffer.from(arrayBuffer);
        const data = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdfdataextract$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["PdfData"].extract(buffer, {
            verbosity: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdfdataextract$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["VerbosityLevel"].ERRORS
        });
        return data;
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3b5417bf._.js.map